# 02 - Deep Dive Report: vinpearl International Guest Support

Team Information
- Team Name: Naturally Gentle

AI Product Scoping Team
...
Nhóm chọn bài toán **"AI Hỗ trợ khách nước ngoài khi sử dụng dịch vụ vinpearl tại Vinpearl / VinCity"** để thực hiện Deep-Dive.

### Lý do chọn
* Đây là vấn đề thực tế của vinpearl khi đón khách du lịch/khách thuê nhà quốc tế: họ cần thông tin hướng dẫn, đặt dịch vụ, và giải đáp nhanh bằng tiếng Anh hoặc ngôn ngữ thân thiện cho khu vực khách du lịch.
...
| Field | Nội dung |
|---|---|
| **1. Actor / Operator** | Nhân viên vinpearl Guest Support hoặc Concierge Team chịu trách nhiệm trả lời yêu cầu của khách nước ngoài tại Vinpearl / VinCity (tiếng Anh / tiếng Trung / tiếng Hàn, v.v.). |
| **2. Current Workflow** | Khi khách nước ngoài gửi yêu cầu qua app vinpearl hoặc hotline, nhân viên phải: 1) đọc và hiểu yêu cầu bằng ngôn ngữ khác; 2) tra cứu thủ công thông tin dịch vụ, lịch trình, quy định an toàn; 3) dịch nội dung chỉ dẫn sang tiếng Anh chuẩn; 4) soạn phản hồi cá nhân hóa; 5) gửi lại và chờ khách xác nhận. Quy trình này kéo dài và phụ thuộc nhiều vào năng lực ngoại ngữ của từng nhân viên. |
...
```text
Khách nước ngoài gửi yêu cầu qua app vinpearl / hotline
        │
        ▼
[1] Nhân viên vinpearl nhận yêu cầu
        │
        ▼
...
[4] AI tạo draft phản hồi bằng tiếng Anh / ngôn ngữ phù hợp
        │
        ▼
[5] Nhân viên vinpearl kiểm tra, chỉnh sửa, phê duyệt draft
        │
        ▼
...
* [x] Stakeholders vinpearl sẵn sàng thay đổi quy trình từ trả lời tay sang hỗ trợ AI draft.
...
* Công việc chính:
  * tích hợp LLM với hệ thống vinpearl request log;
...
## 5. Kết luận
Nhóm khuyến nghị **GO** cho dự án vinpearl International Guest Support. Giải pháp AI nên được triển khai theo scope hẹp: chỉ hỗ trợ soạn draft phản hồi khách nước ngoài và vẫn giữ nhân viên duyệt trước khi gửi để đảm bảo an toàn và compliance.